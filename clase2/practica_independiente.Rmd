...
Vamos a trabajar con un [dataset de Kaggle](https://www.kaggle.com/datasets/ahsan81/job-placement-dataset) que toma datos de contratación de personas en empresas y tiene información acerca de , con datos acerca de sus notas en los exámenes de finalización del secundario (SSC y HSC), y especialización. Las variables que contiene son:
